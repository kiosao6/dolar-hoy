...
export const InputField = ({
  ...
  return (
    <div className="space-y-1">
      <span className="text-sm tracking-tight text-neutral-600">{title}</span>
      <div className="relative">
        <label htmlFor={title} className="absolute text-xl inset-y-0 ps-4 flex items-center">{currencyIndicator}</label>
        <input onChange={callback} id={title} type="number" placeholder={placeholder}
